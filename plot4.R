...
date_data <- as.Date(newdata$Date,'%d/%m/%Y')

data1 <- cbind(newdata, date_data)

## plot 3
  
with(data1, plot(date_data, Sub_metering_1, type ="l", xlab="",ylab="Energy sub metering"))
with(data1, plot(date_data, Sub_metering_2, type ="l", xlab="",ylab="Energy sub metering"))
with(data1, plot(date_data, Sub_metering_3, type ="l", xlab="",ylab="Energy sub metering"))
